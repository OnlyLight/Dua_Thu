...
//	}
	...
	public static Fraction minusFractionArray(ArrayList<Fraction> arrFraction) {
		Fraction minus = arrFraction.get(0);
		
		for(int i = 1; i < arrFraction.size(); i++) {
			minus = minus.hieu(arrFraction.get(i));
		}
		return getReductFraction(minus);
	}
}
