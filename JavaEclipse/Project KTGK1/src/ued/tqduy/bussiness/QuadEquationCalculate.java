...
import ued.tqduy.model.QuadEquation;

public class QuadEquationCalculate {
	private QuadEquation model = new QuadEquation();
	private double x, x1, x2;
	private int check;
	private float a, b, c;
	
	public QuadEquationCalculate() {
	}

	public QuadEquationCalculate(QuadEquation model, double x, double x1, double x2, int check) {
		this.model = model;
		this.x = x;
		this.x1 = x1;
		this.x2 = x2;
