...
public class Teacher {
    ...
    public Teacher(int id, String name, int tuoi) {
        this.id = id;
        this.name = name;
        this.tuoi = tuoi;
    }
    ...
    public void input() {
        ...
        for (int i = 1; i <= num; i++) {
            ...
            Teacher st = new Teacher(id, name, tuoi);
            list.add(st);
        }
        System.out.println("\n--------------\n");
    }
    ...
    public void view() {
        ...
        int i = 1;
        while (itr.hasNext()) {
            Teacher sts = itr.next();
            System.out.println("    " + i + ".   ID=" + sts.getID() + ", Ten=" + sts.getName() + ", Tuoi="
                    + sts.getTuoi());
            i++;
        }
        System.out.println("\n---------\n");
...
//        );
        ...
        System.out.println("\n--Danh sach giao vien sau khi sap xep theo tuoi, ten--");
        list.forEach((d) -> {
            System.out.println("ID=" + d.getID() + ", Ten=" + d.getName() + ", Tuoi=" + d.getTuoi());
        });
        System.out.println("\n--------\n");
    }
...
//        );
        ...
        System.out.println("\n--Danh sach giao vien sau khi sap xep ten, tuoi--");
        list.forEach((d) -> {
            System.out.println("ID=" + d.getID() + ", Ten=" + d.getName() + ", Tuoi=" + d.getTuoi());
        });
        System.out.println("\n--------\n");
    ...
    public void search() {
        ...
        while (itr.hasNext()) {
            ...
            if (sts.getName().equals(name1)) {
                System.out.println("ID=" + sts.getID() + ", Ten=" + sts.getName() + ", Tuoi=" + sts.getTuoi());
            }
        }
        System.out.println("\n-----------\n");
    }
